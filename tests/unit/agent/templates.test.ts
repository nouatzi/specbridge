...
describe('agent templates', () => {
  it('should include expected templates', () => {
    expect(Object.keys(templates)).toEqual(expect.arrayContaining(['code-review', 'refactoring', 'migration']));
  });

  it('should generate strings', () => {
    const ctx: any = { file: 'src/a.ts', applicableDecisions: [], generatedAt: new Date().toISOString() };
